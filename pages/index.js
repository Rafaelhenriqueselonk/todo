...
const tableRowItem = function (item, setOpen, setSelectedObj) {
  return (
    <div key={item.id} className={`list-item ${item.done ? 'done' : ''}`} onClick={() => openDialog(item, setOpen, setSelectedObj)}>
